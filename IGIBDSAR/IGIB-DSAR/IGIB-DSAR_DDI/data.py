...
if __name__ == "__main__":
    ...
    df = pd.read_csv(f'data/raw_data/ChChMiner_train.csv', sep=",")
    processed_data, dataset = build_dataset(df, "smiles_1", "smiles_2", "label")
    torch.save(processed_data, "./data/processed/ChChMiner_train.pt")

    df = pd.read_csv(f'data/raw_data/ChChMiner_valid.csv', sep=",")
    processed_data, dataset = build_dataset(df, "smiles_1", "smiles_2", "label")
    torch.save(processed_data, "./data/processed/ChChMiner_valid.pt")

    df = pd.read_csv(f'data/raw_data/ChChMiner_test.csv', sep=",")
    processed_data, dataset = build_dataset(df, "smiles_1", "smiles_2", "label")
    torch.save(processed_data, "./data/processed/ChChMiner_test.pt")